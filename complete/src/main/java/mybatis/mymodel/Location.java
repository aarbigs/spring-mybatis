...
public class Location {
    ...
    String id;  //: "SABYve",
    String name;  //: "Main Breweries",
    String streetAddress;  //: "2565 North Highway 14",
    String locality;  //: "Inyokern",
    String region;  //: "California",
    String postalCode;  //: "93527",
    String phone;  //: "760-377-5989",
    String website;  //: "http://www.mojavered.com/",
    double latitude;  //: 35.667473,
    double longitude;  //: -117.873665,
    String isPrimary;  //: "Y",
    String inPlanning;  //: "N",
    String isClosed;  //: "N",
    String openToPublic;  //: "Y",
    String locationType;  //: "micro",
    String locationTypeDisplay;  //: "Micro Breweries",
    String countryIsoCode;  //: "US",
    String yearOpened;  //: "1995",
